...
func (n *Nerve) DisableServices() (string, error) {
...
func (n *Nerve) ServicesStatus() string {
	var statuses string
	for _, service := range n.Services {
		statuses += n.ServiceStatus(service)
	}
	return statuses
}

func (n *Nerve) ServiceStatus(service *Service) string {
	b := bytes.Buffer{}
	b.WriteString(service.Name)
	b.WriteString(" ")
	b.WriteString(service.Host)
	b.WriteString(":")
	...
	b.WriteString(strconv.Itoa(int(service.Weight)))
	b.WriteString("\n")
	return b.String()
}
